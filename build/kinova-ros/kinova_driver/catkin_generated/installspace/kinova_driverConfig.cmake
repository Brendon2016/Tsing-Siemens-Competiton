...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'kinova_driver' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/h/catkin_ws/install/${idir}'.  Ask the maintainer 'Kinova ROS Support <ros@kinovarobotics.com>' to fix it.")
    endif()
